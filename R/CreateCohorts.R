...
#
# This file is part of WaltersDementiaModelJson
#
...
.createCohorts <- function(connection,
  ...
  sql <- SqlRender::loadRenderTranslateSql(sqlFilename = "CreateCohortTable.sql",
                                           packageName = "WaltersDementiaModelJson",
  ...
  # Instantiate cohorts:
  pathToCsv <- system.file("settings", "CohortsToCreate.csv", package = "WaltersDementiaModelJson")
